                            ...
                            <footer id="footer" class="footer color-bg" >
                                                        ...
                                                        <form id="newsletter_form" method="POST" data-parsley-validate>
                                                            <div class="row">
                                                                <div class="col-md-5" style={{ padding: 0 }}>
                                                                    <input type="email" name="email" title="Your Email" placeholder="Your Email"
                                                                        data-parsley-required="true" />
                                                                </div>
                                                                <div class="col-1" >
                                                                    <a>
                                                                        <button style={{ marginLeft: 40 , marginTop: 18 }} class="btn search-button"><span class="material-symbols-outlined">mail</span></button>
                                                                    </a>
                                                                </div>
                                                            </div>
                                ...
                                <div class="copyright-bar">
                                    <div class="container-fluid">
                                        ...
                                        <p style={{ display: 'inline', paddingLeft: 750 }}></p>
